...
g <- watts.strogatz.game(1, #dim:	Integer constant, the dimension of the starting lattice.
                         n_people, #size: 	Integer constant, the size of the lattice along each dimension.
                         5, #nei:	Integer constant, the neighborhood within which the vertices of the lattice will be connected.
                         transmision_rate) #p:	Real constant between zero and one, the rewiring probability.
